...
def lambda_handler(event, context):
    ...
    try:
        ...
        multi_id = (s3.create_multipart_upload(Bucket=target_bucket, Key=target_key, ServerSideEncryption='AES256'))['UploadId']
        ...
        while current_size > 0:
            ...
            response = s3.upload_part_copy(CopySourceRange=csr, CopySource=copy_source, Bucket=target_bucket, Key=target_key, UploadId=multi_id, PartNumber=i)
        ...
        response = s3.complete_multipart_upload(Bucket=target_bucket, Key=target_key, MultipartUpload=mpu, UploadId=multi_id)
